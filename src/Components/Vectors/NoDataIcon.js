...
const NoDataIcon = ({size}) => (
  <View>
    <Svg
        ...
        <Rect x="375.66" y="136.55" width="199.84" height="47.27" transform="translate(-212.94 43.72) rotate(-12.11)" fill="#0b2d40" />
        <Path d="M460.93,91.9a27.93,27.93,0,1,0,33.17,21.45A27.93,27.93,0,0,0,460.93,91.9ZM470.17,135a16.12,16.12,0,1,1,12.38-19.14A16.12,16.12,0,0,1,470.17,135Z" transform="translate(-189.92 -59.59)" fill="#0b2d40" />
        ...
        <Rect x="377.02" y="104.56" width="199.84" height="47.27" fill="#0b2d40" />
        <Path d="M666.86,118a27.93,27.93,0,1,0,27.93,27.93A27.93,27.93,0,0,0,666.86,118Zm0,44.05A16.12,16.12,0,1,1,683,145.89,16.12,16.12,0,0,1,666.86,162Z" transform="translate(-189.92 -59.59)" fill="#0b2d40" />
        <G opacity="0.5">
          <Rect x="15.27" y="737.05" width="3.76" height="21.33" fill="#234253" />
          <Rect x="205.19" y="796.65" width="3.76" height="21.33" transform="translate(824.47 540.65) rotate(90)" fill="#234253" />
        </G>
        <G opacity="0.5">
          <Rect x="451.49" width="3.76" height="21.33" fill="#234253" />
          <Rect x="641.4" y="59.59" width="3.76" height="21.33" transform="translate(523.63 -632.62) rotate(90)" fill="#234253" />
        </G>
        ...
        <Circle cx="812.64" cy="314.47" r="7.53" fill="#0b2d40" opacity="0.5" />
        <Circle cx="230.73" cy="746.65" r="7.53" fill="#4d8af0" opacity="0.5" />
        <Circle cx="735.31" cy="477.23" r="7.53" fill="#0b2d40" opacity="0.5" />
        <Circle cx="87.14" cy="96.35" r="7.53" fill="#4d8af0" opacity="0.5" />
        <Circle cx="7.53" cy="301.76" r="7.53" fill="#0b2d40" opacity="0.5" />
      </Svg>
  </View>
);
